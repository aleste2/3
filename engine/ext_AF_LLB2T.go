...
func torqueFnAFLLB2TPRB(dst1, dst2 *data.Slice, hth1a, hth2a, hth1b, hth2b *data.Slice) {
	...
	if Precess {
		cuda.LLBTorqueAF2TPRB(dst1, M1.Buffer(), dst2, M2.Buffer(), dst1, dst2, Te.temp, alpha, alpha1, alpha2, Tcurie, Msat, Msat1, Msat2, hth1a, hth2a, hth1b, hth2b, X_TM, NV, MU1, MU2, J0AA, J0BB, J0AB) // overwrite dst with torque
	} else {
