...
BB0_15:
	...
	mul.f32 	%f36, %f13, %f35;
	fma.rn.f32 	%f37, %f12, %f34, %f36;
	ld.global.f32 	%f38, [%rd33];
	fma.rn.f32 	%f39, %f14, %f38, %f37;
	mul.f32 	%f40, %f54, %f55;
