...
func init() {
	...
	settemperature2_args.argptr[9] = unsafe.Pointer(&settemperature2_args.arg_ScaleNoiseLLB)
	settemperature2_args.argptr[10] = unsafe.Pointer(&settemperature2_args.arg_N)
}

// Wrapper for settemperature2 CUDA kernel, asynchronous.
func k_settemperature2_async(B unsafe.Pointer, noise unsafe.Pointer, kB2_VgammaDt float32, Ms_ unsafe.Pointer, Ms_mul float32, temp_ unsafe.Pointer, temp_mul float32, alpha_ unsafe.Pointer, alpha_mul float32, ScaleNoiseLLB float32, N int, cfg *config) {
	...
	settemperature2_args.arg_ScaleNoiseLLB = ScaleNoiseLLB
...
.visible .entry settemperature2(
	...
	.param .f32 settemperature2_param_9,
...
)
{
	...
	ld.param.f32 	%f25, [settemperature2_param_4];
	ld.param.u64 	%rd4, [settemperature2_param_5];
	ld.param.f32 	%f27, [settemperature2_param_6];
	ld.param.u64 	%rd5, [settemperature2_param_7];
	ld.param.f32 	%f28, [settemperature2_param_8];
	ld.param.f32 	%f13, [settemperature2_param_9];
