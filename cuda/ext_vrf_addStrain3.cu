...
extern "C"
__global__ void
addStrain3(float* __restrict__  dstx, float* __restrict__  dsty, float* __restrict__  dstz,
    ...
    float f1=factor*(C11_2-C12_2)/(C11_3-3*C11*C12_2+2*C12_3);
    float f2=factor*(-C11*C12+C12_2)/(C11_3-3*C11*C12_2+2*C12_3);
    float f3=1.0/C44;

    dstx[I]=f1*sigmaxx+f2*sigmayy;  // exx
    dsty[I]=f2*sigmaxx+f1*sigmayy; // eyy
    dstz[I]=f3*sigmaxy;  // exy
    }
}