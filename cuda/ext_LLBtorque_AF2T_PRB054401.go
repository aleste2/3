...
func LLBTorqueAF2TPRB(torque1,m1,torque2, m2, B1,B2 *data.Slice, temp *data.Slice,alpha,alpha1,alpha2,TCurie,Msat,Msat1,Msat2 MSlice,hth1a *data.Slice,hth2a *data.Slice,hth1b *data.Slice,hth2b *data.Slice,x,nv,mua,mub,J0aa,J0bb,J0ab MSlice) {
	N := torque1.Len()
	cfg := make1DConf(N)
